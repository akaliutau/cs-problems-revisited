 ...
 * each other, and assign the bike to that worker. (If there are multiple
 ...
 * we choose the pair with the smallest bike index). We repeat this process
 ...
 * [[1,2],[3,3]] Output: [1,0] 
 * 
 * xplanation: Worker 1 grabs Bike 0 as they are
 * closest (without ties), and Worker 0 is assigned Bike 1. So the output is [1, 0].
 */
